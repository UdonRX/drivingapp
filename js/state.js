...
export function roadPoint(t,w,h,hor){const p=Math.pow(t,1.72),y=lerp(hor,h*1.04,p),curve=roadCurveAt((1-t)*1250),center=w*.5+curve*w*.22*(1-t)*.9-state.lateral*w*.19*p,halfWidth=lerp(w*.025,w*.56,p);return{x:center,y,halfWidth,perspective:p}}
